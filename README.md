...
- <img src="https://cdn.simpleicons.org/android/3DDC84" width="18" height="18" alt="Android" valign="middle"> **Android (APK)** : [télécharger la dernière version](https://expo.dev/artifacts/eas/KQkugG_9gpYqHa4eezroNTPbc32vTxOCEQYr1qeQc5Q.apk)
  — ouvre ce lien depuis le téléphone, installe l'APK (autorise « sources inconnues » si demandé).
- <img src="https://cdn.simpleicons.org/apple/888888" width="18" height="18" alt="macOS" valign="middle"> **macOS** : voir [App Desktop (Tauri)](#app-desktop-tauri) pour générer le `.dmg`.
- <img src="https://cdn.simpleicons.org/apple/888888" width="18" height="18" alt="iOS" valign="middle"> **iOS** : build EAS à venir (nécessite un compte Apple Developer).
