...
- <img src="assets/windows.svg" width="18" height="18" alt="Windows" valign="middle"> **Windows (.exe)** : [télécharger la dernière version](https://github.com/furaxdev/Islam-pro/releases/download/desktop-latest/Islam.Pro_1.0.0_x64-setup.exe)
